...
import {
    aboutList, addAbout, addAds, addBestSeller, addDecoration, addDesigner, addDiscoverSweets, addDryFruit,
...
/*----------------------------- planning elp ---------------*/
AdminRouter.get("/planning-help-req", Authentication, Authorization(["Admin"]), planningHelpReq)


/*------------------------ privacy-policy----------------*/
AdminRouter.post('/privacy-policy', Authentication, Authorization(["Admin"]), updatePrivacyPolicy);

AdminRouter.post('/term-condition', Authentication, Authorization(["Admin"]), termAndCondition);

AdminRouter.post('/shipping', Authentication, Authorization(["Admin"]), shipping);

AdminRouter.post('/payment-refund', Authentication, Authorization(["Admin"]), paymentRefund);
